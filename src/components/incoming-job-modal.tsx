...
const RINGTONE_URL =
  "https://upload.wikimedia.org/wikipedia/commons/c/cd/US_ringback_tone.ogg";
...
export function IncomingJobModal({
  ...
  const serviceTitle = job
    ? getJobServiceName(job)
        ...
        <View style={styles.content}>
          ...
          <View style={styles.detailsCard}>
            <Detail
              ...
              value={bookingId ? String(bookingId) : "Not provided"}
            />
...
const styles = StyleSheet.create({
  ...
  detailsCard: {
    ...
    gap: 13,
    borderRadius: 20,
    backgroundColor: "rgba(20,38,61,0.94)",
    borderWidth: 1,
    borderColor: "#244462",
  },
